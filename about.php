...
<div class="procardMain" style="" id="procardMain">
    ...
    <img src="about/AD0004462-1.jpg"  class="center">
  </div>
  <!-- <h1  >About us</h1> -->
<br><br>
  <div class="paragraph paragraph2 w3-card-4 w3-margin">
    <p> durakathanapala is the best platform where you can buy and sell mobile phones.You can buy the phone you want from a place very close to you. Also, the seller will be able to sell your mobile phone very quickly through this platform..</p>
  </div>

<div class="wrapper">
  <h1>About Durakathanapala</h1>
  <div class="team">
    <div class="team_member">
      <div class="team_img">
        <img src="about/mobile-selling-1955596-1648852-removebg-preview.png" alt="Team_image">
      </div>
      <h3>Are there phones for sale?</h3>
      <p class="role">UI developer</p>
      <p>Sign up for a free account to start selling your items! It takes few  minutes to post an ad. Visit How to sell fast for some tips on creating great ads that generate a lot of buyer interest.  We also have some great tools that help make your ad stand out from the rest. Check out the Ad Promotions page for more information.</p>
    </div>
    <div class="team_member">
      <div class="team_img">
        <img src="about/download-removebg-preview (1).png" alt="Team_image">
      </div>
      <h3>Do you want to buy a phone?</h3>
      <p class="role">Tester</p>
      <p>If you want to buy a phone, you must first create a free account and register. Then select the phone model you want and start searching for it.</p></div>
    <div class="team_member">
      <div class="team_img">
        <img src="about/depositphotos_105278918-stock-illustration-phone-spare-parts-for-repairs-removebg-preview.png" alt="Team_image">
      </div>
      <h3>Do you need telephone parts?</h3>
      <p class="role">Support Lead</p>
      <p>If you need phone parts, you can easily find them on our website.</p>
    </div>
  </div>
</div>  
