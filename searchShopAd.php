...
.search_wrap .search_box2 .input{
	...
	#laststep2{display:none;} 
#otherOpenTime{display:none;}	 
#shopcontactCard, #shopcontactCard2, #exin1shop, #exin2shop{display:none;}
         ...
         if (user != "") {
		  ...
		  if(createPost == "1"){
		   ...
		   var yes ="yes";
	         ...
	         document.getElementById("shopcontactCard2").style.display = "inline";
		   $.ajax({
