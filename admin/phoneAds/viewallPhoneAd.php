...
<body id="page-top">
	...
	<script>
	  function rejectAd(){
		  ...
		  if(rMsg != ""){
			  var id = "<?php echo $id; ?> "; 
			   window.location.href = 'viewPhoneallAd-a.php?action=return&id='+ id+"&rejectMsg="+rMsg;
		  }
	  }
	</script>
  </div><?php
...
?>
		...
		<br><br>
		 <div class="w3-row " style="width:60%; margin:auto;">
            ...
            <div class="w3-half ">
              <p style="text-align:center;"><a href="viewPhoneallAd-a.php?action=delete&id=<?php echo $id; ?>" ><button class="w3-button w3-red">Delete</button></a></p>
            </div>
            </div>
        </div>
