...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                <a href="../phoneshopAdsTable.php"><button class="rounded-circle border-0" id="sidebarToggle"></button></a>
            </div>
	...
	<script>
	  function rejectAd(){
		  ...
		  if(rMsg != ""){
			  var id = "<?php echo $id; ?> "; 
			   window.location.href = 'viewPhoneshopAd-a.php?action=return&id='+ id+"&rejectMsg="+rMsg;
		  }
	  }
	</script>
  </div><?php
...
<div class="mySlides fad">
  ...
  <p style="text-align:center;"><img src="../../adsPictures/shopAds/<?php echo $sellerId; ?>/<?php echo $publishTime; ?>/<?php echo $images; ?>" style="max-width:390px; max-height:400px; width:auto; height:auto; "></p>
  <div class="text"></div>
</div>
<?php
			}}
		...
		<br><br>
		  ...
		  <div class="w3-row " style="width:60%; margin:auto;">
            <div class="w3-third ">
              <?php
		   if($updateAdminApproval == "1"){
			  ?> <p style="text-align:center;"><a href="viewPhoneshopAd-a.php?action=UpdateApproval&id=<?php echo $id; ?>" ><button class="w3-button w3-green">Approval</button></a></p><?php
			}else{
			  ?> <p style="text-align:center;"><a href="viewPhoneshopAd-a.php?action=approval&id=<?php echo $id; ?>" ><button class="w3-button w3-green">Approval</button></a></p><?php
			} 
			?>
            </div>
            <div class="w3-third ">
            ...
            <div class="w3-third ">
              <p style="text-align:center;"><a href="viewPhoneshopAd-a.php?action=delete&id=<?php echo $id; ?>" ><button class="w3-button w3-red">Delete</button></a></p>
            </div>
            </div>
