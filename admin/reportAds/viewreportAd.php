...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Check Report Ads Place</h1>
       

	<?php						
    if(isset($_GET["reId"])){   
     $reId = $_GET["reId"];
	 $sql = "SELECT * FROM `reportads` WHERE `id` ='$reId'";
	...
	<script>
	  function rejectAd(){
		  ...
		  if(rMsg != ""){
			  var id = "<?php echo $id; ?> "; 
			   window.location.href = 'viewreportAd-a.php?ad=phoneAd&action=return&id='+ id+"&rejectMsg="+rMsg;
		  }
	  }
	</script>
  </div><?php
               ...
               $sql = "select * from `phoneads`  where `id` = '$postId' ";
	           $res = mysqli_query($conn,$sql);
               $count = mysqli_num_rows($res);
		       if($count>0){
		        while($row=mysqli_fetch_assoc($res)){
...
<div class="mySlides fad">
  ...
  <p style="text-align:center;"><img src="../../adsPictures/<?php echo $sellerId; ?>/<?php echo $publishTime; ?>/<?php echo $images; ?>" style="max-width:200px; max-height:200px; width:auto; height:auto; "></p>
  <div class="text"></div>
</div>
<?php
			}}
...
?>
  <div style="width:80%; background-color:#ddd; margin:5px auto; height:260px; padding:15px 10px;">
    <h5 style="text-align:center; color:black; opacity:0.8;"><b>Report info</b></h5><br>
	<div style="width:100%; display:flex;">
	 <div style="width:45%;"><b>Reason:</b> <?php echo $reason; ?></div>
	 <div style="width:55%;"><b>Date:</b> <?php echo $Time; ?></div>
	</div>
	<div style="margin:10px 0 0; text-align:center;"><b>Sender:</b> <?php echo $sender; ?></div>
	<br>
	<div><b>Report Message:</b></div>
	<div style="margin:5px 0 0;"> <textarea id="p2" style="border:1px solid #ddd; padding:5px; width:100%; background-color:white;"   rows="3" disabled="disabled"> <?php echo $remsg; ?>.</textarea></div>
		...
		<br><br>
		  ...
		  <div class="w3-row " style="width:60%; margin:auto;">
            ...
            <div class="w3-half ">
              <p style="text-align:center;"><a href="viewreportAd-a.php?ad=phoneAd&action=delete&id=<?php echo $postId; ?>" ><button class="w3-button w3-red">Delete</button></a></p>
            </div>
            </div>
                 ...
                 $count = mysqli_num_rows($res);
		          if($count>0){
		           while($row=mysqli_fetch_assoc($res)){				   		                	
				    ...
				    $sql = "SELECT * FROM `reportads` WHERE `PostId` ='$postId'";
	            $res = mysqli_query($conn,$sql);
                $no = mysqli_num_rows($res);				
	?>	 
        <div class = "product-content loadAds skeleton">
		<div class="loadAds loadTohide">
		<div style="float:right; color:red;"><h5><b>All Reports To This Ad:</b> <span style="width:20px; height:20px; border-radius:20px; background-color:red; color:white; padding:10px;"><?php echo $no; ?></span></h5></div>
	...
	<script>
	  function rejectAd(){
		  ...
		  if(rMsg != ""){
			  var id = "<?php echo $id; ?> "; 
			   window.location.href = 'viewreportAd-a.php?ad=shopAd&action=return&id='+ id+"&rejectMsg="+rMsg;
		  }
	  }
	</script>
  </div><?php
                    $sql = "select * from `phoneshopads`  where `id` = '$postId' ";
	           $res = mysqli_query($conn,$sql);
               $count = mysqli_num_rows($res);
		       if($count>0){
		        while($row=mysqli_fetch_assoc($res)){
...
<div class="mySlides fad">
  <div class="numbertext" style="color:black;">1 / <?php echo $count; ?></div>
  <p style="text-align:center;"><img src="../../adsPictures/shopAds/<?php echo $sellerId; ?>/<?php echo $publishTime; ?>/<?php echo $images; ?>" style="max-width:200px; max-height:200px; width:auto; height:auto; "></p>
  <div class="text"></div>
</div>
<?php
			}}
...
?>
  <div style="width:80%; background-color:#ddd; margin:10px auto; height:260px; padding:15px 10px;">
    <h5 style="text-align:center; color:black; opacity:0.8;"><b>Report info</b></h5><br>
	<div style="width:100%; display:flex;">
	 <div style="width:45%;"><b>Reason:</b> <?php echo $reason; ?></div>
	 <div style="width:55%;"><b>Date:</b> <?php echo $Time; ?></div>
	...
	<div style="margin:5px 0 0;"> <textarea id="p2" style="border:1px solid #ddd; padding:5px; width:100%; background-color:white;"   rows="3" disabled="disabled"> <?php echo $remsg; ?>.</textarea></div>
		...
		<br><br>
		  ...
		  <div class="w3-row " style="width:60%; margin:auto;">
            ...
            <div class="w3-half ">
              <p style="text-align:center;"><a href="viewreportAd-a.php?ad=shopAd&action=delete&id=<?php echo $postId; ?>" ><button class="w3-button w3-red">Delete</button></a></p>
            </div>
            </div>
	...
	?>	 
		...
		<div style="float:right; color:red;"><h5><b>All Reports To This Ad:</b> <span style="width:20px; height:20px; border-radius:20px; background-color:red; color:white; padding:10px;"><?php echo $no; ?></span></h5></div>
          ...
          <div class="w3-row w3-border" style="margin:10px 0;">
		     <div class="w3-row w3-border w3-padding">
		      <label style="font-size:14px; color:black; font-weight:bold; opacity:0.8;">For sale by: <span  style="margin:0 7px; background-color:#ddd; padding:3px;"><?php echo $m; ?> <?php echo $fullname; ?></span></label>
			 </div>
			 <div class="w3-row w3-border w3-padding">
